...
export default class UpdateQuestionScreen extends React.Component {
                    ...
                    <View style={styles.formContainer}>            
                        ...
                        <ProgressStep label="Question" 
                                ...
                                <View>
                                    ...
                                    {
                                        (this.props.navigation.getParam('typequestion', 0) == 1)
                                        ?
                                        <Input
                                            inputStyle={{color: Colors.inputColor, fontSize: 15}}
                                            placeholderTextColor={Colors.inputPlaceholderColor}
                                    ...
                                    {
                                        (this.props.navigation.getParam('typequestion', 0) == 2 || this.props.navigation.getParam('typequestion', 0) == 3)
                                        ?
                                        <View id="response">
                                            { this.state.data ? 
                                                <AnimatedListView
                                                    ...
                                                    renderRow={item =>
                                                        <View key={item.id} style={[styles.row, {marginTop: 5}]}>
                                                            <View style={styles.column1}>
                                                                {
                                                                    (this.props.navigation.getParam('typequestion', 0) == 2)
                                                                    ?
                                                                    <TouchableOpacity onPress={() => this._chooseResponseQCM(item.id)}>
                                                                        <FeatherIcon style={ [styles.whiteText, {marginTop: 10}] } name={item.check ? 'check-square' : 'square'} />
                                                                    </TouchableOpacity> 
                                                                    :
                                                                    <TouchableOpacity onPress={() => this._chooseResponseQCU(item.id)}>
    ...
    _updateQuestion = async () => {
        ...
        if(source === 'fil')
            page = 'FilQuestion';
        else if(source === 'myquestion')
            page = 'MyQuestion'
        else
            page = 'MyQuestionnaire'
