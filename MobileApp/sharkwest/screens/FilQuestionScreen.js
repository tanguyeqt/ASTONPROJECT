...
export default class FilQuestionScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    var rows = [
      ...
      },
      {
        ...
        note: 4.2,
        rated: false,
        question: 'Quel groupe chante la chanson Bohémian Rapsody ?',
        response: 
        {
          typeresponse: 3,
          correctresponse: ['Queen'],
          incorrectresponse: ['Prince', 'King']
        },
        avis: 6,
        comments: 3,
        uses: 625,
  ...
  renderRow(record){
    return(
        <Question source={"fil"} navigation={this.props.navigation} {...record} />
    );
  }
